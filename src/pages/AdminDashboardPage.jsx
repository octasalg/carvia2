      ...
      <div className="modal" onClick={(e) => e.stopPropagation()}>
        ...
        <div className="modal-body">
          ...
          <div className="form-toggles" style={{ flexWrap: "wrap", gap: "14px 24px" }}>
            ...
            <label className="switch">
              <input type="checkbox" checked={f.precio_especial} onChange={(e) => setF({ ...f, precio_especial: e.target.checked })} />
              <span className="switch-track" /><span className="switch-label">💲 Precio especial</span>
            </label>
            <label className="switch">
